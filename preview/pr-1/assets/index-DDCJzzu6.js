(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=[`Pre-nursery`,`Nursery`,`Reception`,`Year 1`,`Year 2`,`Year 3`,`Year 4`,`Year 5`,`Year 6`,`Year 7`,`Year 8`];function t(e,t){return t>=9?e:e-1}function n(e){let t=e+1;return`${e}/${String(t).slice(-2)}`}function r(e){return`1 September ${e} – 31 August ${e+1}`}function i(e=new Date){let t=e.getMonth()+1,n=e.getFullYear();return t>=9?n:n-1}function a(e){return e+2}function o(e,t){return a(e)+t}function s(t,r){let i=e[r],a=o(t,r);return{yearGroup:i,entryYear:a,academicYearLabel:n(a),entryDate:new Date(a,8,1)}}function c(n,a=new Date){let o=n.getFullYear(),c=t(o,n.getMonth()+1),l=c+1,u=e.map((e,t)=>s(o,t)),d=u[0],f=new Date(a.getFullYear(),a.getMonth(),a.getDate()),p=u.find(e=>e.entryDate>=f)??null;return{dateOfBirth:n,cohortStartYear:c,cohortEndYear:l,cohortLabel:r(c),firstPointOfEntry:d,allEntryPoints:u,nextPointOfEntry:p,currentAcademicYearStart:i(a)}}function l(e){if(!e)return null;let t=e.split(`-`).map(Number);if(t.length!==3)return null;let[n,r,i]=t;if(!n||!r||!i)return null;let a=new Date(n,r-1,i);return a.getFullYear()!==n||a.getMonth()!==r-1||a.getDate()!==i?null:a}function u(e){return e.toLocaleDateString(`en-GB`,{day:`numeric`,month:`long`,year:`numeric`})}var d=document.querySelector(`#app`);d.innerHTML=`
  <main class="page">
    <header class="hero">
